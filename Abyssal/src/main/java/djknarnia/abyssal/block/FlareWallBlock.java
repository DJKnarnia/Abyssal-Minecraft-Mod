...
public class FlareWallBlock extends FlareBlock {
	
	public static final DirectionProperty HORIZONTAL_FACING = HorizontalBlock.HORIZONTAL_FACING;
	private static final Map<Direction, VoxelShape> SHAPES = Maps.newEnumMap(ImmutableMap.of(
			Direction.NORTH, Block.makeCuboidShape(5.5d, 3d, 11d, 10.5d, 13d, 16d), 
			Direction.SOUTH, Block.makeCuboidShape(5.5d, 3d, 0d, 10.5d, 13d, 5d), 
			Direction.WEST, Block.makeCuboidShape(11d, 3d, 5.5d, 16d, 13d, 10.5d), 
			Direction.EAST, Block.makeCuboidShape(0d, 3d, 5.5d, 5d, 13d, 10.5d)));

	public FlareWallBlock(Properties properties) {
		super(properties);
    ...
    public void animateTick(BlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        ...
        worldIn.addParticle(ParticleTypes.SMOKE, false, d0 + offset0 + d4 * (double) direction1.getXOffset(), d1 + offset1 + d3, d2 + offset2 + d4 * (double) direction1.getZOffset(), 0F, 0F, 0F);
        worldIn.addParticle(ParticleTypes.FLAME, false, d0 + d4 * (double) direction1.getXOffset(), d1 + d3 - 0.1D, d2 + d4 * (double) direction1.getZOffset(), 0F, 0F, 0F);
    }
}
